...
function EventboardCombat2(props) {
  ...
  const attackArray = [
    {
      attack: 'Overhand',
      attackValue: 1.5,
      attackChance: Math.round((45 + (dex - props.monsterDex)) / 1.5),
      monAttackChance:  Math.round((55 + (props.monsterDex - dex)) / 1.5),
    },
    {
      attack: 'Slash',
      attackValue: 1,
      attackChance: Math.round((45 + (dex - props.monsterDex))),
      monAttackChance:  Math.round((55 + (props.monsterDex - dex))),
    },
    {
      attack: 'Stab',
      attackValue: 0.7,
      ...
      <React.Fragment>
        ...
        <div>
          <div className='eventText'>
            ...
            <h4 className="choosePath">The enemy wants to fight right now!</h4>
...
export default EventboardCombat2;